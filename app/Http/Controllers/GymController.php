...
class GymController extends Controller
{
    public function index()
    {
        ...
        return view('gyms.list')->with($data);
    }
    ...
    public function edit(Request $request, Gyms $gym)
    {
        ...
        return view('gyms.details')->with($data);
    }
    ...
    public function editMember(Request $request, Gyms $gym, User $member)
    {
        if ($request->method() == "POST") {
            ...
            return redirect()->route('gyms.view', ['gym' => $member->gym_id]);
        }
        $data = [
    ...
    public function delete(Gyms $gym){
        $gym->delete();
        return redirect()->route('gyms.list');
    }
    ...
    public function view(Gyms $gym)
    {
        ...
        return view('gyms.view')->with($data);
    }

    public function add()
    {
        return view('gyms.add')->withTitle("Add new Gym");
    }
    ...
    public function store(Request $request)
    {
        ...
        $g = Gyms::create($input);
        return redirect()->route('gyms.view', ['gym' => $g->id]);
    }
}
